...
# RocNet linux TCP upload throughput measurement script (using netperf)
# Author(s): Feidias Moulianitakis, Anselm Meyn
#
# Required arguments: IP of the server, Zabbix configuration file

# defaults
UNREACHABLE=0
KEY=rocnet.tcp.tpt.up
...
coproc NWTEST {
  TEST_OP=$($NETPERF_CMD -H $1 -t TCP_MAERTS -P 0 -v 0 -f m -l 10)
