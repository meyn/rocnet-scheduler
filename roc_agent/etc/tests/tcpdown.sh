...
# RocNet linux TCP download throughput measurement script (using netperf)
...
# a readable Zabbix configuration file (second argument)
...
coproc NWTEST {
  TEST_OP=$($NETPERF_CMD -H $1 -t TCP_STREAM -P 0 -v 0 -f m -l 10)
